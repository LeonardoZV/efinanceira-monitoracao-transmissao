...
public class CaptureLedgerPostingsJob {
    ...
    public static void executar(String[] args) throws Exception {
        ...
        SparkSession spark = SparkSession.builder()
                .appName("CaptureLedgerPostingsJob")
                .master("local[*]")
                .getOrCreate();
        ...
        spark.readStream()
                ...
                .option("kafka.group.id", "CaptureAccountingJournalEntryEventsJob")
...
//				.option("truncate", false)
                ...
                .format("parquet")
                .outputMode("append")
                .option("checkpointLocation", "D:\\s3\\event-driven-ledger\\bkt-checkpoint-data\\CaptureLedgerPostingsJob")
                .trigger(Trigger.Once())
                .start("D:\\s3\\event-driven-ledger\\bkt-staging-data\\ledger-posting-created-events")
                .awaitTermination();
